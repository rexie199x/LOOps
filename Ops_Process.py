...
def main():
    ...
    menu_options = ["General Processes", "Discord Related Processes", "Email Templates", "Document Templates", "Templates", "Post Templates", "Links", "Timelines", "Dashboard", "Blank Doc", "Blank Doc2" ]
